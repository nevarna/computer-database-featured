...
public class DAOCompanyImplTest {
    ...
    public void deleteTest() {
        boolean reussi = ((DAOCompanyImpl) ctx.getBean(DAOCompanyImpl.class)).delete(1);
        boolean rater = ((DAOCompanyImpl) ctx.getBean(DAOCompanyImpl.class)).delete(60);
        assertEquals(true, reussi);
        assertEquals(false, rater);
    }
